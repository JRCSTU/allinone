...
## GUI
#
$mkshortcut "$mymenu_folder\\CO2MPAS_GUI-$app_ver" \
    "${mywdir}CO2MPAS.vbs" \
...
## Consoles
#
$mkshortcut "$mymenu_folder\\CO2MPAS_CONSOLE-$app_ver" \
    "${mywdir}CONSOLE.vbs" \
...
## HOME
#
home="$(cygpath -aw "$HOME")"
$mkshortcut "$mymenu_folder\\CO2MPAS_HOME-$app_ver" \
    "${home}" \
    /desc:"Opens a CO2MPAS home folder." \
    /workingdir:"${home}" \
    /icon:"${mywdir}Apps\\CO2MPAS_logo.ico" \
    /show:min
