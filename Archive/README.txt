        ...
        - In *command-prompt*, type:
          ...
          .. code-block:: console
            ...
            Volume Serial Number is 688C-C286
             ...
             Directory of D:\Apps\co2mpas_AIO-v1.6.2\CO2MPAS
   ...
   output is quasi-similar:
        ...
        - In *command-prompt*, type:
          ...
          .. code-block:: console
            ...
            > where python
            D:\Apps\co2mpas_AIO-v1.6.2\Apps\WinPython\python-3.5.3\python.exe
            D:\Apps\co2mpas_AIO-v1.6.2\Apps\Cygwin\bin\python

            > co2mpas --version
            co2mpas-1.6.2 at D:\Apps\co2mpas_AIO-v1.6.2\Apps\WinPython\python-3.5.2.amd64\lib\site-packages\co2mpas
        ...
        - In *bash*, type:
          ...
          .. code-block:: console
            ...
            > which python
            /d/Apps/co2mpas_AIO-v1.6.2/Apps/WinPython/python-3.5.3/python
